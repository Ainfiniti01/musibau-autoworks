...
import ServicesChart from '../components/ServiceChart';
    ...
    <>
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8 justify-items-center">
          {/* Existing Cards */}
          <div className="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 text-center border border-gray-200 dark:border-gray-600 flex flex-col items-center w-full max-w-xs">
