      ...
      try {
        if (editingService) {
          ...
          const response = await fetch('/api/services.php', {
            ...
            body: JSON.stringify({ ...newService, action: 'update', id: editingService.id }),
          });
          ...
          const serviceWithId = { ...newService, id: data.id };
    ...
    const deletePromise = new Promise(async (resolve, reject) => {
      try {
        const response = await fetch('/api/services.php', {
          ...
          body: JSON.stringify({ action: 'delete', id: serviceToDeleteId }),
        });
                  ...
                  {currentServices.map((service) => (
                    <tr key={service.id}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <button onClick={() => handleEditService(service)} className="bg-blue-500 text-white px-2 py-1 rounded mr-2 inline-flex items-center">
                          <FiEdit className="inline-block mr-1"/> Edit
                        </button>
                        <button onClick={() => handleDeleteService(service.id)} className="bg-red-500 text-white px-2 py-1 rounded mr-2 inline-flex items-center">
