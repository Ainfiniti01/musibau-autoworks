...
const BookingHistory = () => {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      ...
      setBookings([
        { id: 1, customer: 'John Doe', organization: 'Global Solutions', service: 'Oil Change', mechanic: 'Mike', status: 'Completed', date: '2023-10-20', hasReceipt: true, userType: 'Active' },
        { id: 2, customer: 'Jane Smith', organization: null, service: 'Tire Rotation', mechanic: 'Sarah', status: 'Completed', date: '2023-10-25', hasReceipt: true, userType: 'Guest' },
        { id: 3, customer: 'Acme Corp', organization: 'Acme Corp', service: 'Brake Inspection', mechanic: 'Mike', status: 'Cancelled', date: '2023-10-28', hasReceipt: false, userType: 'Active' },
        { id: 4, customer: 'Bob Johnson', organization: null, service: 'Engine Tune-up', mechanic: 'John', status: 'Pending', date: '2023-10-29', hasReceipt: false, userType: 'Guest' },
        { id: 5, customer: 'Global Solutions', organization: 'Global Solutions', service: 'Wheel Alignment', mechanic: 'Sarah', status: 'Completed', date: '2023-10-30', hasReceipt: true, userType: 'Active' },
        { id: 6, customer: 'Alice Brown', organization: null, service: 'Exhaust Repair', mechanic: 'Mike', status: 'Pending', date: '2023-11-01', hasReceipt: false, userType: 'Guest' },
        { id: 7, customer: 'Tech Innovations', organization: 'Tech Innovations', service: 'Battery Check', mechanic: 'John', status: 'Completed', date: '2023-11-02', hasReceipt: true, userType: 'Active' },
        { id: 8, customer: 'Charlie Davis', organization: null, service: 'AC Service', mechanic: 'Sarah', status: 'Cancelled', date: '2023-11-03', hasReceipt: false, userType: 'Guest' },
        { id: 9, customer: 'Future Enterprises', organization: 'Future Enterprises', service: 'Transmission Fluid Change', mechanic: 'Mike', status: 'Completed', date: '2023-11-04', hasReceipt: true, userType: 'Active' },
        { id: 10, customer: 'Diana Miller', organization: null, service: 'Brake Pad Replacement', mechanic: 'John', status: 'Pending', date: '2023-11-05', hasReceipt: false, userType: 'Guest' },
      ]);
      setIsLoading(false);
    };
    fetchBookings();
  ...
  const filteredBookings = bookings.filter(booking => {
    ...
    const matchesUserType = filterUserType === 'all' || booking.userType === filterUserType;
    ...
    return matchesSearch && matchesCustomerOrOrg && matchesService && matchesMechanic && matchesStatus && matchesUserType && matchesDateRange;
  });
