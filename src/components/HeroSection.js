    ...
    >
      ...
      <div className="relative z-10 p-5">
        ...
        <div className="flex justify-center gap-4" data-aos="fade-up" data-aos-delay="400">
          <button className="bg-yellow-500 text-black py-3 px-6 rounded-lg font-semibold hover:bg-yellow-400 transition duration-300">
            Get a Quote
          </button>
          <button className="bg-transparent text-white py-3 px-6 rounded-lg border-2 border-yellow-500 hover:bg-yellow-500 hover:text-black transition duration-300">
            Learn More
          </button>
        </div>
      </div>
