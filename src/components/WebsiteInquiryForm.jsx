...
const WebsiteInquiryForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { fullName, email, phone, description, budget } = formData;
...
💰 Budget: ${budget || "Not specified"}
      ...
      const whatsappUrl = `https://wa.me/2349095707751?text=${encodeURIComponent(message)}`;
      ...
      toast.error("Failed to redirect to WhatsApp. Please try again.");
    } finally {
  ...
  return (
    <div className="bg-[#0B0D1F] py-10 px-6 md:px-20">
      <h2 className="text-3xl font-bold text-center text-white mb-8 py-10">
        Build Your Website Inquiry
      </h2>
